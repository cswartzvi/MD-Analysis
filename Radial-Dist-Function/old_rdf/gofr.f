      ...
      parameter(nofgx=600,mic=1,mic3=mic*mic*mic)
...
C=======================================================================
      ...
      do ipt = 1, npt
        ...
        if(ipt.ge.istart .and. mod(ipt,iostride).eq.0) then
          ...
          !write(60,*) omega, box, res

          do is = 1,nsp
            do ia=1,na(is)
               call r_to_s(tau(1,ia,is),stau(1,ia,is))
               !write(64,*) (stau(j,ia,is),j=1,3) 
            end do  
          end do
     ...
     C             STAUR(1,IA,is),STAUR(2,IA,is),STAUR(3,IA,is),1)
              ...
              DO J=IINF,ISUP
                DO K=IINF,ISUP
                  DO IA=1,NA(IS)
                    ...
                    !WRITE(111,*) STAUR(1,IA,IS), STAUG(1,IC,IS)
                  END DO
                END DO
              END DO
            END DO
          ...
          DO iout = 1, nout
            ...
            DO L = 1, LAX
              ...
              !If they are the SAME atom-type
              IF(K .EQ. J) THEN
                INF = L + 1
              ELSE
                INF = 1
...
c     WRITE(6,1747)
      ...
      write(*,*) 'TEST', omega, box, boxby2, res
      ...
      DO iout = 1, nout
        DO ir = 1, nofg
         ...
         write(87,*) ngdr(ir,iout)
         write(88,*) erre * 0.52917, erre2 
         write(89,*) erre * 0.52917, ngdr(ir,iout)
